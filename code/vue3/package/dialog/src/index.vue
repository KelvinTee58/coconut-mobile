<template>
  <div class="coo-dialog" :class="[customClass]" :style="[customStyle]">
    <coo-overlay :visible="overlayVisible" @click="closeDialogFunction" @close="overlayCloseEvent">
      <template>
        <div class="coo-dialog-wrapper" @click.stop>
          ...
          <div class="coo-dialog__buttonWrapper">
            <div class="coo-dialog__buttonWrapper--button coo-dialog__buttonWrapper--cancel" v-if="cancelShow" @click="cancelClick">
              {{ cancelShowText }}
            </div>
            <div class="coo-dialog__buttonWrapper--button coo-dialog__buttonWrapper--confirm" v-if="confirmShow" @click="confirmClick">
              {{ confirmShowText }}
            </div>
          </div>
        </div>
